...
<body  onresize="winResize();" onload="winResize();">
    ...
    <div id="main_wrapper">
        ...
        <div id="statusbar">
            <span>Location:&nbsp;</span><location style="cursor: default; padding-right: 10px;
        ...
        <div id="details_all" style="display: none;">
                                ...
                                <tr>
                                    <th>
                                        <div id="divSelectAllFiles" style="display: none;">
                                            <span>All</span><br />
                                            <input type="checkbox" id="chkSelectAllFiles" title="Select/UnSelect all items" />
                                        </div>
                                    </th>
                                    <th>
                                        Filename
            ...
            <div id="details">
                <div id="thumbnails">
                    <div id="thumbsearch">
                        <div style="text-align: center;">
                            <div id="divThumbSelectAll" style="display: none; flex-grow: 1; flex-shrink: 1;">
                                <input type="checkbox" id="chkThumbSelectAll" title="Select/Unselect all thumbnails"
                                    style="cursor: pointer; margin-top: 8px; margin-left: 7px; margin-right: 5px;" />
                                <label style="cursor: pointer;" for="chkThumbSelectAll" title="Select/Unselect all thumbnails">
                                    All</label>
                            </div>
                        </div>
                        <div style="display: flex; text-align: right;">
                            <input type="text" id="vidSearchText" />
                ...
                <div id="playing">
                    <div id="player">
                        <video id="videoplayer" type="video/mp4" controls autoplay loop style="background-color: #000000;">
                        <source id="vid" src=""></source>
                    </video>
                    </div>
                    <div style="display:flex;">
                        <button  style="border-radius:0px;cursor:pointer;" onclick="DownloadASX()">
    ...
    <div id="duration_form" title="Create ASX File">
        <p style="margin:10px 5px;line-height:20px;" id="lblASXTitle">Enter ASX File title</p>
        <div style="display:flex;flex-direction:column;">
        <input 
            style="padding:5px;color:black;border-radius:5px;" 
            type="text" id="vidASXTitle" value="title" />
        </div>
        <p style="margin:15px 5px;line-height:20px;" id="durLabel">Enter Video Duration</p>
        <div>
        <input 
            style="padding:5px;color:black;border-radius:5px;text-align:center;" 
            type="text" id="durValue" value="0" /><span>&nbsp;&nbsp;Seconds</span>
        </div>
    </div>
    ...
    <div id="login_form" title="User Login">
        <table cellspacing="10" id="logTable">
            <tr>
                ...
                <td>
                    <input style="padding:5px;color:black; border-radius:5px;" type="text" id="logUID" value="">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input style="padding:5px;color:black; border-radius:5px;" type="password" id="logPWD" value="">
                </td>
            </tr>
        </table>
    </div>
    ...
    <div id="about_dialog" title="About Inspection Video Library">
        <div id="aboutVer" style="display:none;position:absolute;z-index:100;color:red;top:120px;font-size:0.8em;text-align:right;width:495px;"><%=AppVer()%></div>
       <img style="position:relative;" src="images/ivl.png" title="About instpection Video Library"  alt="About instpection Video Library"/>
    </div>
